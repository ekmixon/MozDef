...
class message(object):
    ...
    def onMessage(self, message, metadata):
        ...
        newmessage = {
            ...
            "mozdefhostname": message["mozdefhostname"],
            "tags": ["aws", "guardduty"] + message["tags"],
            "category": "guardduty",
            "source": "guardduty",
            "customendpoint": "",
            "details": {},
        ...
        if (
            message["details"]["finding"]["action"]["actionType"] != "AWS_API_CALL"
            and "networkInterfaces"
            in message["details"]["resource"]["instanceDetails"]
        ):
        ...
        # Propagate domain
        if (
            "miscinfo" in newmessage["details"]
            and "domain" in newmessage["details"]["miscinfo"]
        ):
        ...
        if (
            newmessage["details"]["finding"]
            in [
                "UnauthorizedAccess:EC2/RDPBruteForce",
                "UnauthorizedAccess:EC2/SSHBruteForce",
            ]
            and newmessage["details"]["direction"] == "OUTBOUND"
        ):
        ...
        if (
            newmessage["details"]["direction"] == "INBOUND"
            and "destinationipaddress" not in newmessage["details"]
            and "publicip" in newmessage["details"]
        ):
            newmessage["details"]["destinationipaddress"] = newmessage["details"]["publicip"]
        if (
            newmessage["details"]["direction"] == "OUTBOUND"
            and "sourceipaddress" not in newmessage["details"]
            and "publicip" in newmessage["details"]
        ):
